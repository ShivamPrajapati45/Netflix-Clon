...
const LikedCard = React.memo(({movieData, isLiked=false}) => {
                ...
                <div className="info-container flex column">
                    ...
                    <div className="icons flex  j-between">
                        <div className="controls flex">
                            ...
                            <RiThumbUpFill title='like' className={like === true ? "like" : "default"} onClick={() => setLike(true)}/>
                            <RiThumbDownFill title='dislike' className={like === false ? "dislike" : "default"} onClick={() => setLike(false)}/>
                            {
                                isLiked ? 
