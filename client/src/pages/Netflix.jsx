        ...
        <div className='player'>
          {
            ...
            (
              <ReactPlayer url={`https://www.youtube.com/watch?v=${trailerFromStore.length > 0 ? trailerFromStore[0]?.key : ""}`}  className="background-image"  controls={true} width='100%' height='100%' playing={true}/>
            ) : (
              <img 
                  src = {details ? `https://image.tmdb.org/t/p/w500${details?.backdrop_path}` : `${backgroundImage}`}
              alt="backgroundImage" className='background-image' /> 
            )
          }
